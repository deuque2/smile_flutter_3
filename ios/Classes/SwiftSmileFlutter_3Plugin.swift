...
public class SwiftSmileFlutter_3Plugin: NSObject, FlutterPlugin,
SIDCaptureManagerDelegate,SIDConsentManagerDelegate,BVNConsentResultDelegate {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let instance = SwiftSmileFlutter_3Plugin()
    ...
    func submitJob(tag: String, jobType: Int?, isProduction: Bool?,callBackUrl:String?, partnerParams: Dictionary<String, String>?,  idInfo: Dictionary<String, String>?,  geoInfo: Dictionary<String, Any>?, result: @escaping FlutterResult) {
        ...
        var docVUseEnrolledImage = false
        ...
        if let idInfo = idInfo{
            ...
            for (key, value) in idInfo {
                ...
                case "use_enrolled_image":
                    docVUseEnrolledImage = (value as NSString).boolValue
                default:
        ...
        if(jobType == 6){
            sidConfig.setUseEnrolledImage(useEnrolledImage: docVUseEnrolledImage)
        }
